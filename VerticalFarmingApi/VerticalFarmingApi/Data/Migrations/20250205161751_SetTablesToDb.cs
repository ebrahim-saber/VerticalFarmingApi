...
{
    /// <inheritdoc />
    public partial class SetTablesToDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CropHealthReports_Farms_FarmId",
                        column: x => x.FarmId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiseaseAlerts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DiseaseAlerts_Farms_FarmId",
                        column: x => x.FarmId,
                        principalTable: "Farms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AIAnalysisResults_Crops_CropId",
                        column: x => x.CropId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIAnalysisResults_CropId",
                table: "AIAnalysisResults",
                column: "CropId");

            migrationBuilder.CreateIndex(
                name: "IX_CropHealthReports_FarmId",
